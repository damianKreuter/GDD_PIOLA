...
--17
	...
	fact_esta_codigo		INT NOT NULL,			-- [FK] Ref a ESTADIA.esta_codigo
	fact_clie_codigo		INT NOT NULL,            -- [FK] Ref a CLIENTE.clie_codigo
	fact_fecha				DATETIME,--
	fact_dias_efectuados	NUMERIC(18,0),
	fact_dias_no_efectuados NUMERIC(18,0),
...
--17
	...
	ALTER TABLE Recaptchat.FACTURA ADD CONSTRAINT FK_fact_esta_codigo FOREIGN KEY (fact_esta_codigo) REFERENCES Recaptchat.ESTADIA(esta_codigo);
...
PRINT 'Eliminar Constrains ...';
	...
	ALTER TABLE Recaptchat.ESTADO_HOTEL DROP CONSTRAINT FK_esho_hote_codigo
		...
		ALTER TABLE Recaptchat.FACTURA DROP CONSTRAINT FK_fact_esta_codigo
...
PRINT 'Insetando valores para FACTURA'	
	INSERT INTO Recaptchat.FACTURA
	   (fact_numero, fact_esta_codigo, fact_clie_codigo, fact_fecha, fact_total)
	SELECT DISTINCT  
					(SELECT DISTINCT M2.Factura_Nro),
					EXC.estaxcli_esta_codigo,
				    C.clie_codigo,
	...
	JOIN Recaptchat.ESTADIA_X_CLIENTE EXC on EXC.estaxcli_clie_codigo = C.clie_codigo
...
PRINT 'Insetando valores para ITEM_FACTURA'
	INSERT INTO Recaptchat.ITEM_FACTURA
		(item_fact_numero, item_cons_codigo, item_descripcion, item_monto, item_cons_cantidad)
		SELECT DISTINCT M.Factura_Nro,
			ISNULL(M.Consumible_Codigo,'SIN CODIGO'),
			ISNULL(M.Consumible_Descripcion,'SIN DESCRIPCION'),
			ISNULL(M.Consumible_Precio,'SIN VALOR'),
			M.Item_Factura_Cantidad
		FROM GD_Esquema.Maestra M
			JOIN Recaptchat.Estadia e ON e.esta_rese_codigo = M.Reserva_Codigo
			JOIN Recaptchat.ESTADIA_HABITACIONES EHAB ON EHAB.estaxhabi_esta_codigo = e.esta_codigo
		WHERE M.Factura_Nro IS NOT NULL



select * from Recaptchat.ESTADIA
select * from Recaptchat.HOTEL
select * from Recaptchat.HABITACION                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        